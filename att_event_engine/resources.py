...
class Asset(IOTObject):
    ...
    def _getDefinition(self): 
        ...
        if not self._definition:
            ...
            elif self._gateway or self._device._gateway:
    ...
    def value(self):
        ...
        if not self._id in valueStore:
            result = iot.getAssetState(self.id)['value']
...
class Actuator(Asset):
    ...
    def _setValue(self, value):
        ...
        iot.send(self._id, value, gateway=self._gateway, device=self._device)
